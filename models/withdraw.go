...
type Withdraw struct {
	...
	BankName    string `json:"bank_name" gorm:"not null;type:varchar(12)" validate:"required"`
	BankNumber  string `json:"bank_number" gorm:"not null;type:varchar(20)" validate:"required,max=10,min=10"`
