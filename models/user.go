...
type User struct {
	...
	Picture       string           `json:"picture" gorm:"type:varchar(5000);default:https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Windows_10_Default_Profile_Picture.svg/768px-Windows_10_Default_Profile_Picture.svg.png" validate:"max=5000"` // Picture is a link to the picture
	Point         int32            `json:"point" gorm:"type:int;default:0"`                                                                                                                                                                                 // Point is the point of the user
	Address       *Address         `json:"address" gorm:"foreignKey:UserID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`                                                                                                                                  // Address is the address of the user
	VideoHistory  *[]VideoHistory  `json:"video_history" gorm:"foreignKey:UserID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`                                                                                                                            // History is the history of the user
	CourseHistory *[]CourseHistory `json:"course_history" gorm:"foreignKey:UserID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`                                                                                                                           // CourseHistory is the course history of the user
	...
	Transaction   *[]Payment       `json:"payment" gorm:"foreignKey:UserID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`                                                                                                                                  // Tracsaction is the tracsaction of the user
	DoneExercise  []*Video         `json:"done_exercise" gorm:"many2many:user_doneexercise;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`                                                                                                                  // DoneExercise is the exercise user has done
}
