...
type Reward_Item struct {
	...
	Item_name    string `json:"item_name" gorm:"not null;type:varchar(200)" validate:"required,max=200"`        // Item_name is the name of the item
	Item_title   string `json:"item_title" gorm:"not null;type:varchar(200)" validate:"required,max=200"`     // Item_title is the title of the item
